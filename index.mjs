...
app.post("/render", jsonParser, renderRequest, validateResume, async (req, res) => {
  res.send(await render(req.body.resume, req.body.theme));
});

app.post("/render_pdf", jsonParser, renderRequest, validateResume, async (req, res) => {
...
app.post('/test', jsonParser, renderRequest, validateResume, async(req,res) => {
